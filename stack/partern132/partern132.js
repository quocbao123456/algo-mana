// https://leetcode.com/problems/132-pattern/   (32.3%)
/**
 * @param {number[]} nums
 * @return {boolean}
 */
...
//                         console.log("nums[start]", nums[start], nums[peak], nums[third])
...
//     function dp(index, f, s) {
//         if(result1) return true;
//         count++;
//         if (index >= nums.length) return false;
//         const curr = nums[index];

//         if (memozieds[`${index}-${f}-${s}`] !== undefined)
//             return memozieds[`${index}-${f}-${s}`];

//         if (index && curr === nums[index - 1]) {
//             return dp(index + 1, f, s);
//         }
...
//         if (f === Infinity) {
//             result = dp(index + 1, curr, -Infinity);
//         } else if (s === -Infinity && curr < f) {
//             result = dp(index + 1, curr, s);
//         } else if (s === -Infinity && curr > f) {
//             result = dp(index + 1, f, curr);
//         } else if (curr > s) {
//             result = dp(index + 1, f, curr);
//         }else if (curr < f) {
//             console.log("skip", index, f, s, curr)
//             result = dp(index + 1, f, s) || dp(index, Infinity, -Infinity);
//         } else {
//             result = dp(index + 1, f, s);
//         }

//         memozieds[`${index}-${f}-${s}`] = result;

//         return result;
//     }
//     const result = dp(0, Infinity, -Infinity);
//     console.log("memozieds", memozieds)
//     console.log("count", count)
//     return result;
// };
...
const find132pattern = (nums) => {
    ...
    for (let index = nums.length - 1; index >= 0; index--) {
        console.log("stack", stack, s3)
        if(nums[index] < s3) return true;
...
// console.log(find132pattern([-3, -10, -8, -3, -10, -6, -10, -6, -1, -10]));

// console.log(find132pattern([3, 1, 4, 2]));

// console.log(find132pattern([8, 10, 4, 6, 5]));

// // console.log(find132pattern([-10, -10, -9, -10, -10, -10, -10, -9]));

// // console.log(find132pattern([1, 4, 0, -1, -2, -3, -1, -2]));
// console.log(find132pattern([0,-100000,200000,-300000,400000,-500000,600000,-700000,800000,-900000,1000000,-1100000,1200000,-1300000,1400000,-1500000,1600000,-1700000,1800000,-1900000,2000000,-2100000,2200000,-2300000,2400000,-2500000,2600000,-2700000,2800000,-2900000,3000000,-3100000,3200000,-3300000,3400000,-3500000,3600000,-3700000,3800000,-3900000,4000000,-4100000,4200000,-4300000,4400000,-4500000,4600000,-4700000,4800000,-4900000,5000000,-5100000,5200000,-5300000,5400000,-5500000,5600000]));
